...
) ENGINE=InnoDB AUTO_INCREMENT=136 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `checkout_detail` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKhj6f44xswy8bv8nfuunfbo2c8` (`book_id`),
  KEY `FKeoj3ifyguf4mrla6l72schf9c` (`checkout_id`),
  CONSTRAINT `FKeoj3ifyguf4mrla6l72schf9c` FOREIGN KEY (`checkout_id`) REFERENCES `checkout` (`id`),
  CONSTRAINT `FKhj6f44xswy8bv8nfuunfbo2c8` FOREIGN KEY (`book_id`) REFERENCES `book` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `generator_sequence`
--

DROP TABLE IF EXISTS `generator_sequence`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `generator_sequence` (
...
CREATE TABLE `oder_detail` (
  ...
  `ordertotal_id` bigint DEFAULT NULL,
  `quantity` int DEFAULT NULL,
  `book_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKc89t1qprywm5o8n81ouvemuj7` (`ordertotal_id`),
  KEY `FKjb5wr5ii9sgiowbyeggkk9f1p` (`book_id`),
  CONSTRAINT `FKc89t1qprywm5o8n81ouvemuj7` FOREIGN KEY (`ordertotal_id`) REFERENCES `order_total` (`id`),
  CONSTRAINT `FKjb5wr5ii9sgiowbyeggkk9f1p` FOREIGN KEY (`book_id`) REFERENCES `book` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_total` (
  `id` bigint NOT NULL,
  `amount_totail` decimal(21,2) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `sequence_gengerator`
--

DROP TABLE IF EXISTS `sequence_gengerator`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sequence_gengerator` (
  `next_val` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `spring_session` VALUES ('1f99838f-70a0-419f-9ba7-884e14c3fc22','5f52dc8f-e4a0-49fc-adaa-4a4fa93113f2',1708310213080,1708310213080,1800,1708312013080,'admin69'),('bfc1caea-8425-4221-980e-66f23b3c693c','d0e58e27-90de-4c7f-ba84-7f60bfaf6c92',1708310213074,1708310213074,1800,1708312013074,'admin69');
...
INSERT INTO `spring_session_attributes` VALUES ('1f99838f-70a0-419f-9ba7-884e14c3fc22','SPRING_SECURITY_CONTEXT',_binary '�\�\0sr\0=org.springframework.security.core.context.SecurityContextImpl\0\0\0\0\0\0:\0L\0authenticationt\02Lorg/springframework/security/core/Authentication;xpsr\0Oorg.springframework.security.authentication.UsernamePasswordAuthenticationToken\0\0\0\0\0\0:\0L\0credentialst\0Ljava/lang/Object;L\0	principalq\0~\0xr\0Gorg.springframework.security.authentication.AbstractAuthenticationTokenӪ(~nGd\0Z\0\rauthenticatedL\0authoritiest\0Ljava/util/Collection;L\0detailsq\0~\0xpsr\0&java.util.Collections$UnmodifiableList�%1�\�\0L\0listt\0Ljava/util/List;xr\0,java.util.Collections$UnmodifiableCollectionB\0�\�^�\0L\0cq\0~\0xpsr\0java.util.ArrayListx�\��\�a�\0I\0sizexp\0\0\0w\0\0\0sr\0Borg.springframework.security.core.authority.SimpleGrantedAuthority\0\0\0\0\0\0:\0L\0rolet\0Ljava/lang/String;xpt\0\nROLE_ADMINxq\0~\0\rsr\0Horg.springframework.security.web.authentication.WebAuthenticationDetails\0\0\0\0\0\0:\0L\0\rremoteAddressq\0~\0L\0	sessionIdq\0~\0xpt\00:0:0:0:0:0:0:1ppsr\0*bookstore.app.book.security.UserDetailImpl\�g\�\�{*U�\0L\0authoritiesq\0~\0L\0passwordq\0~\0L\0usernameq\0~\0xpsq\0~\0\0\0\0w\0\0\0q\0~\0xt\0<$2a$10$NstJT9dwgP60hAH0gh//be9XbXpRjAoNCAftOZBU5cVkNNqa2jTaKt\0admin69'),('bfc1caea-8425-4221-980e-66f23b3c693c','SPRING_SECURITY_CONTEXT',_binary '�\�\0sr\0=org.springframework.security.core.context.SecurityContextImpl\0\0\0\0\0\0:\0L\0authenticationt\02Lorg/springframework/security/core/Authentication;xpsr\0Oorg.springframework.security.authentication.UsernamePasswordAuthenticationToken\0\0\0\0\0\0:\0L\0credentialst\0Ljava/lang/Object;L\0	principalq\0~\0xr\0Gorg.springframework.security.authentication.AbstractAuthenticationTokenӪ(~nGd\0Z\0\rauthenticatedL\0authoritiest\0Ljava/util/Collection;L\0detailsq\0~\0xpsr\0&java.util.Collections$UnmodifiableList�%1�\�\0L\0listt\0Ljava/util/List;xr\0,java.util.Collections$UnmodifiableCollectionB\0�\�^�\0L\0cq\0~\0xpsr\0java.util.ArrayListx�\��\�a�\0I\0sizexp\0\0\0w\0\0\0sr\0Borg.springframework.security.core.authority.SimpleGrantedAuthority\0\0\0\0\0\0:\0L\0rolet\0Ljava/lang/String;xpt\0\nROLE_ADMINxq\0~\0\rsr\0Horg.springframework.security.web.authentication.WebAuthenticationDetails\0\0\0\0\0\0:\0L\0\rremoteAddressq\0~\0L\0	sessionIdq\0~\0xpt\00:0:0:0:0:0:0:1ppsr\0*bookstore.app.book.security.UserDetailImpl\�g\�\�{*U�\0L\0authoritiesq\0~\0L\0passwordq\0~\0L\0usernameq\0~\0xpsq\0~\0\0\0\0w\0\0\0q\0~\0xt\0<$2a$10$NstJT9dwgP60hAH0gh//be9XbXpRjAoNCAftOZBU5cVkNNqa2jTaKt\0admin69');
...
CREATE TABLE `users` (
  ...
  `odertotal_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKphmpf5k83vggjqslv0vfcvhdx` (`odertotal_id`),
  CONSTRAINT `FKphmpf5k83vggjqslv0vfcvhdx` FOREIGN KEY (`odertotal_id`) REFERENCES `order_total` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-02-19  9:51:24
